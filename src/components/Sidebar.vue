<template>
    <aside class="sidebar">
        ...
        <ul class="sidebar__list">
            <li class="sidebar__item" :class="{active: cryptoStore.activePortfolio === 'main'}" @click="selectPortfolio('main', '/mainnet')">
        ...
        <button class="sidebar__btn">Create Portfolio</button>
    </aside>
</template>
